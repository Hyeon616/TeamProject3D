...
>>>>>>> 25396ae (Ï§åÏù∏/ÏàòÎ•òÌÉÑ Î™®ÏÖò Ï∂îÍ∞Ä)
    public float BasePlayerHp = 50.0f;
    public int currentBullet = 30;//ΩÓ∞Ì ≥≤¿∫ «ˆ¿Á √—æÀ ∞≥ºˆ 
    public int maxBullet = 100;//øπ∫Ò √—æÀ ∞≥ºˆ
    public int currentBulletTemp = 30;//¿Â¿¸ Ω√ 30∞≥ √§øˆ¡ˆµµ∑œ «œ¥¬ ∫Øºˆ
    ...
    void Start()
    {
        ...
        Debug.Log($"ƒ≥∏Ø≈Õ HP : {BasePlayerHp}");
    }
    ...
    {
        reload = false;
        //√—æÀ ∏Ó ∞≥ Ω˙¥¬¡ˆ ∞ËªÍ«ÿº≠ bulletsToReloadø° ≥÷¿Ω
        int bulletsToReload = currentBulletTemp - currentBullet;
        //∞ËªÍµ» ∞≥ºˆ currentBullet ø©±‚ √ﬂ∞°«ÿ¡÷∞Ì
